...
/*   Updated: 2022/07/22 17:45:34 by odessein         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "pipex.h"
...
static void	pp_hardlink_cmd(char *path_lst, char **cmd, char **path,
		char **path_cmd)
{
...
static t_bool	pp_not_in_env(char *cmd, t_bool *valid, t_info *info,
			t_list *new)
{
	if (!(*valid))
	{
